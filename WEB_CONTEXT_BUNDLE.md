...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-46167"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-v1",
      "problem_contract_sha256": "8db0da49122b8ee73209c02e2422422e4e7fc8bd9463999aff73ec1d1f8d7f21",
      "problem_id": "problem:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798",
      "route_id": "route:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-source-fidelity-01",
      "graph_id": "graph:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Every digraph with chromatic number at least $2k-2$ contains every oriented tree of order $k$ as a subdigraph."
          },
          "statement_sha256": "972c83641e64f6befed5507e5965eb5e008c3ab3285a0704777ad8e351e92073"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-root",
      "route_id": "route:um-opg-46167-oriented-trees-in-n-chromatic-digraphs-9ea85798-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-46167-e51826c38cb6",
        "url": "https://www.unsolvedmath.com/problems/OPG-46167"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
